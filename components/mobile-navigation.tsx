...
export function MobileNavigation() {
  ...
  return (
    <nav className="fixed bottom-[-1px] left-0 right-0 bg-white border-t border-gray-200 py-1 px-4 rounded-tr-[35px] rounded-tl-[35px]">
        ...
        {navItems.map((item) => {
          ...
          return (
            <Link
              key={item.href}
              href={item.href}
              className={cn("flex flex-col  items-center p-2", isActive ? "text-teal-800" : "text-dark")}
            >
